...
document.getElementById("required_sketch").innerHTML = "sketch to be drawn : " + sketch;
...
function clearCanvas(){
    background("aliceblue");
    random_number = Math.floor((Math.random()*quick_draw_data_set.length)+1);
    answer_holder = quick_draw_data_set[random_number];
    document.getElementById("required_sketch").innerHTML = sketch;
}
